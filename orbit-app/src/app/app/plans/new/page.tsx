...
async function createPlan(formData: FormData) {
  ...
  if (!goalInput) {
    // Minimal validation – in a real app you'd surface a form error.
    // For now, just refuse to create an empty plan.
  ...
  await prisma.plan.create({
    data: {
      ...
      intensity,
      // userId: later when you add auth
    },
  });

  // Make sure the list page sees the new plan
